package net.sebastianopoggi.samples.ui.GlowPadSample;
...
//        });
        ...
        glowPad.setOnTriggerListener(new GlowPadView.OnTriggerListener() {
            ...
            public void onTrigger(View v, int target) {
            	if(target == 0)
            	{
            		Toast.makeText(SampleActivity.this, "Call picked", Toast.LENGTH_SHORT).show();
            	}
            	else
            	{
            		Toast.makeText(SampleActivity.this, "Call Declined", Toast.LENGTH_SHORT).show();
            	}
